...
The current baseline is: `ruff check src tests examples` clean; `SKIP_ENGINE_TESTS=1 py -3.11 -m pytest -q` reports `264 passed, 4 skipped`; a full run `py -3.11 -m pytest -q` reports `263 passed, 5 skipped`.
